...
def create_part_data( wallet_id, name, amount, service_id):
    data_create_part = {
        "amount": amount,
        "wallet_id": wallet_id,
...
# exapmle : 
# 1:    data_create_part = create_part_data( wallet_id, name, amount, service_id) 
# 2:    part_id = create_part(data_create_part)
# 3:    data_spend_from_part = spend_part_data(amount, section_wallet_id, section_percent)
# 4:    response_data = spend_from_part(part_id, data_spend_from_part)
# 5:    ... END
